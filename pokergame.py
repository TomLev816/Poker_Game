...
def card_hand():
    ...
    for each in players:
        each.card1 = card_dealt()
        each.card2 = card_dealt()
        each.hand = each.card1 + each.card2

    #Players hand
    playerHand.card1 = card_dealt()
    playerHand.card2 = card_dealt()
    ...
    userAns = input("Fold (f) or Call (c): ").upper()
    ...
    print (board1) #prints flop1
    print (board2) #prints flop2
    print (board3) #prints flop3
    print (" ")

    #userAns = input("Are you ready to see the turn: ").upper()
    print (board4) #prints turn
    print (" ")

    #userAns = input("Are you ready to see the river: ").upper()
    print (board5) #prints river
    print (" ")
    print (" ")
    ...
    #def post_hand_rank(seat,player_hand):

    if userAns == "Call" or userAns == "C":
        print ("Your hand was" , playerHand.hand)
    else:
        print ("Folded")

    userAns = input("Would you like to play another hand? (Y/N) :").upper()
    if userAns == "Y":
        card_hand()

userAns = input("Would you like to play poker? (Y/N) :").upper()
if userAns == "Y":
    card_hand()
