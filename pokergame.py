...
def hand_rank(seat,player_hand):
    def check_pairs(seat,player_hand):
        if player_hand[0][0] == player_hand[1][0]:
            if player_hand[0][0] == "4" or player_hand[0][0] == "3" or player_hand[0][0] == "2":
                #print ("Low Pocket pair")
                return 7
            elif player_hand[0][0] == "5" or player_hand[0][0] == "6":
                #print ("Low-mid Pocket pair")
                return 6        
            elif player_hand[0][0] == "8" or player_hand[0][0] == "7":
                #print ("mid Pocket pair")
                return 5        
            elif player_hand[0][0] == "9" or player_hand[0][0] == "T":
    ...
    def has_ace(seat,player_hand):
        if player_hand[0][0] == "A" or player_hand[1][0] == "A":
            if player_hand[0][1] == player_hand[1][1]:
                if player_hand[0][0] == "K" or player_hand[1][0] == "K":
                    #print ("has suited AK")
                    return 1
                elif player_hand[0][0] == "Q" or player_hand[1][0] == "Q" or player_hand[0][0] == "J" or player_hand[1][0] == "J":
                    #print ("has suited AQ or AJ")
                    return 2
                elif player_hand[0][0] == "T" or player_hand[1][0] == "T":
                    #print ("has suited AT")
                    return 3
                else:
                ...
                if player_hand[0][0] == "K" or player_hand[1][0] == "K":
                    ...
                    return 2
                elif player_hand[0][0] == "Q" or player_hand[1][0] == "Q":
                    #print ("has unsuited AQ")
                    return 3
                elif player_hand[0][0] == "J" or player_hand[1][0] == "J":
                    #print ("has unsuited AJ")
                    return 4
                elif player_hand[0][0] == "T" or player_hand[1][0] == "T" or player_hand[0][0] == "9" or player_hand[1][0] == "9":
                    #print ("has mid-high unsuited Ace")
                    return 7
                elif player_hand[0][0] == "7" or player_hand[1][0] == "7" or player_hand[0][0] == "8" or player_hand[1][0] == "8":
    ...
    def has_king(seat,player_hand):
        if player_hand[0][0] == "K" or player_hand[1][0] == "K":
            if player_hand[0][1] == player_hand[1][1]:
                if player_hand[0][0] == "Q" or player_hand[1][0] == "Q":
                    #print ("has suited KQ")
                    return 2
                elif player_hand[0][0] == "T" or player_hand[1][0] == "T" or player_hand[0][0] == "J" or player_hand[1][0] == "J":
                    #print ("has suited KJ or KT")
                    return 3
                elif player_hand[0][0] == "9" or player_hand[1][0] == "9":
                    #print ("has suited K9")
                    return 6
                else:
    ...
    def has_queen(seat,player_hand):
        if player_hand[0][0] == "Q" or player_hand[1][0] == "Q":
            if player_hand[0][1] == player_hand[1][1]:
                if player_hand[0][0] == "J" or player_hand[1][0] == "J":
                    #print ("has suited QJ")
                    return 3
                elif player_hand[0][0] == "T" or player_hand[1][0] == "T":
                    #print ("has suited KJ or KT")
                    ...
                    #print ("has suited Q9")
                    return 6
                elif player_hand[0][0] == "8" or player_hand[1][0] == "8":
                    #print ("has suited Q8")
                    return 7
                else:
    ...
    def has_jack(seat,player_hand):
        if player_hand[0][0] == "J" or player_hand[1][0] == "J":
            if player_hand[0][1] == player_hand[1][1]:
                if player_hand[0][0] == "T" or player_hand[1][0] == "T":
                    #print ("has suited JT")
                    return 3
                elif player_hand[0][0] == "9" or player_hand[1][0] == "9":
                    #print ("has suited J9")
                    ...
                    #print ("has suited J8")
                    return 6
                elif player_hand[0][0] == "7" or player_hand[1][0] == "7":
                    #print ("has suited J7")
                    return 8
                else:
    ...
    def has_ten(seat,player_hand):
        if player_hand[0][0] == "T" or player_hand[1][0] == "T":
            if player_hand[0][1] == player_hand[1][1]:
                if player_hand[0][0] == "9" or player_hand[1][0] == "9":
    ...
    def has_nine(seat,player_hand):
        if player_hand[0][0] == "9" or player_hand[1][0] == "9":
            if player_hand[0][1] == player_hand[1][1]:
                if player_hand[0][0] == "6" or player_hand[1][0] == "6":
                ...
                if player_hand[0][0] == "8" or player_hand[1][0] == "8":
        ...
        if player_hand[0][0] == "8" or player_hand[1][0] == "8":
            if player_hand[0][1] == player_hand[1][1]:
                if player_hand[0][0] == "6" or player_hand[1][0] == "6":
                    ...
                    return 6
                elif player_hand[0][0] == "5" or player_hand[1][0] == "5":
                ...
                if player_hand[0][0] == "7" or player_hand[1][0] == "7":
                    #print ("has unsuited 9-8")
                    return 8
                else:
        ...
        if player_hand[0][0] == "7" or player_hand[1][0] == "7":
            if player_hand[0][1] == player_hand[1][1]:
                if player_hand[0][0] == "6" or player_hand[1][0] == "6":
                    ...
                    return 6
                elif player_hand[0][0] == "4" or player_hand[1][0] == "4":
    ...
    def has_six(seat,player_hand):
        if player_hand[0][0] == "6" or player_hand[1][0] == "6":
            if player_hand[0][1] == player_hand[1][1]:
                if player_hand[0][0] == "5" or player_hand[1][0] == "5":
    ...
    def has_five(seat,player_hand):
        if player_hand[0][0] == "5" or player_hand[1][0] == "5":
            if player_hand[0][1] == player_hand[1][1]:
                if player_hand[0][0] == "4" or player_hand[1][0] == "4":
                    #print ("has suited 5-4")
                    return 6
                elif player_hand[0][0] == "3" or player_hand[1][0] == "3":
                    #print ("has suited 5-4")
                    return 7
                else:
    ...
    def has_four(seat,player_hand):
        if player_hand[0][0] == "4" or player_hand[1][0] == "4":
            if player_hand[0][1] == player_hand[1][1]:
                if player_hand[0][0] == "3" or player_hand[1][0] == "3":
